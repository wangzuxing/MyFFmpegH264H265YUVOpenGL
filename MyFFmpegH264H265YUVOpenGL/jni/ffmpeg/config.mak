...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-memalign-hack --target-os=linux --arch=arm --enable-version3 --enable-gpl --enable-nonfree --enable-shared --disable-doc --disable-stripping --disable-ffmpeg --disable-ffplay --disable-ffserver --disable-ffprobe --disable-avdevice --disable-network --disable-swresample --disable-zlib --enable-avfilter --enable-avcodec --enable-avformat --enable-swscale --enable-postproc --enable-network --disable-everything --enable-encoder=h263 --enable-encoder=mp2 --enable-encoder=mpeg2video --enable-encoder=mpeg4 --enable-encoder=rawvideo --enable-encoder=flv --enable-encoder=libmp3lame --enable-encoder=libx264 --enable-encoder=libfaac --enable-decoder=aac --enable-decoder=h264 --enable-decoder=h263 --enable-decoder=flv --enable-decoder=mp3 --enable-decoder=mpeg4 --enable-muxer=h263 --enable-muxer=mp2 --enable-muxer=mp3 --enable-muxer=mp4 --enable-muxer=matroska --enable-muxer=matroska_audio --enable-muxer=mpeg2dvd --enable-muxer=mpeg2sdvd --enable-muxer=mpeg2video --enable-muxer=mpeg2vob --enable-muxer=mpegts --enable-muxer=rawvideo --enable-demuxer=rtsp --enable-muxer=rtsp --enable-hwaccels --enable-bsfs --enable-protocol=rtp --enable-protocol=file --enable-libmp3lame --enable-libx264 --enable-libfaac --enable-librtmp --enable-zlib --disable-debug --enable-cross-compile --cc='F:/cygwin64/android-ndk-r8d/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-gcc-4.4.3' --cross-prefix='F:/cygwin64/android-ndk-r8d/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-' --nm='F:/cygwin64/android-ndk-r8d/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-nm' --ar='F:/cygwin64/android-ndk-r8d/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-ar' --extra-cflags='-IF:/cygwin64/android-ndk-r8d/platforms/android-8/arch-arm/usr/include -IF:/cygwin64/android-ndk-r8d/platforms/android-8/arch-arm/usr/include/faac -fPIC -DANDROID' --disable-asm --extra-ldflags='-Wl,-T,F:/cygwin64/android-ndk-r8d/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/arm-linux-androideabi/lib/ldscripts/armelf_linux_eabi.x -W1,-rpath-link=F:/cygwin64/android-ndk-r8d/platforms/android-8/arch-arm/usr/lib -LF:/cygwin64/android-ndk-r8d/platforms/android-8/arch-arm/usr/lib -nostdlib F:/cygwin64/android-ndk-r8d/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/lib/gcc/arm-linux-androideabi/4.4.3/crtbegin.o F:/cygwin64/android-ndk-r8d/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/lib/gcc/arm-linux-androideabi/4.4.3/crtend.o -lc -lm -ldl'
prefix=/usr/local
...
ARCH=c
INTRINSICS=none
CC=F:/cygwin64/android-ndk-r8d/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-gcc-4.4.3
CXX=F:/cygwin64/android-ndk-r8d/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-g++
AS=F:/cygwin64/android-ndk-r8d/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-gcc-4.4.3
OBJCC=F:/cygwin64/android-ndk-r8d/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-gcc-4.4.3
LD=F:/cygwin64/android-ndk-r8d/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-gcc-4.4.3
DEPCC=F:/cygwin64/android-ndk-r8d/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-gcc-4.4.3
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=F:/cygwin64/android-ndk-r8d/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-gcc-4.4.3
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
AR=F:/cygwin64/android-ndk-r8d/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-ar
ARFLAGS=rc
AR_O=$@
RANLIB=F:/cygwin64/android-ndk-r8d/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-ranlib
STRIP=echo skipping strip
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC -DZLIB_CONST
CFLAGS=  -IF:/cygwin64/android-ndk-r8d/platforms/android-8/arch-arm/usr/include -IF:/cygwin64/android-ndk-r8d/platforms/android-8/arch-arm/usr/include/faac -fPIC -DANDROID -march=armv5te -std=c99 -fomit-frame-pointer -fPIC -marm -pthread -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
OBJCFLAGS=  
ASFLAGS=  -IF:/cygwin64/android-ndk-r8d/platforms/android-8/arch-arm/usr/include -IF:/cygwin64/android-ndk-r8d/platforms/android-8/arch-arm/usr/include/faac -fPIC -DANDROID -march=armv5te -fPIC
AS_C=-c
AS_O=-o $@
OBJCC_C=-c
OBJCC_E=-E -o $@
...
LD_PATH=-L
DLLTOOL=
WINDRES=F:/cygwin64/android-ndk-r8d/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-windres
DEPWINDRES=F:/cygwin64/android-ndk-r8d/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/bin/arm-linux-androideabi-gcc-4.4.3
DOXYGEN=doxygen
LDFLAGS= -Wl,-T,F:/cygwin64/android-ndk-r8d/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/arm-linux-androideabi/lib/ldscripts/armelf_linux_eabi.x -W1,-rpath-link=F:/cygwin64/android-ndk-r8d/platforms/android-8/arch-arm/usr/lib -LF:/cygwin64/android-ndk-r8d/platforms/android-8/arch-arm/usr/lib -nostdlib F:/cygwin64/android-ndk-r8d/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/lib/gcc/arm-linux-androideabi/4.4.3/crtbegin.o F:/cygwin64/android-ndk-r8d/toolchains/arm-linux-androideabi-4.4.3/prebuilt/windows/lib/gcc/arm-linux-androideabi/4.4.3/crtend.o -lc -lm -ldl  -march=armv5te -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDLIBFLAGS=
...
EXTRALIBS=-lx264 -lrtmp -lssl -lcrypto -lz -lmp3lame -lfaac -lm -lz -pthread 
